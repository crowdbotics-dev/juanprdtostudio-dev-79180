...
## Project Structure
    ...
    ├── juanprdtostudio_dev_79180  # Django project configurations
...
1. Clone this repo and `cd juanprdtostudio_dev_79180`
...
2. Clone this repo and `cd juanprdtostudio_dev_79180`
